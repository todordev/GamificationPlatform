...
class GamificationModelActivity extends JModelAdmin {
     ...
     * @since   1.6
     */
    public function getTable($type = 'Activity', $prefix = 'GamificationTable', $config = array()){
    ...
    public function save($data){
        ...
        $info         = JArrayHelper::getValue($data, "info");
