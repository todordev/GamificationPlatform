...
<div class="row-fluid">
     <div class="span8">&nbsp;</div>
	<div class="span4">
        <a href="http://itprism.com/free-joomla-extensions/ecommerce-gamification/crowd-donations-manager" target="_blank"><img src="../media/com_gamification/images/logo.png" alt="<?php echo JText::_("COM_GAMIFICATION");?>" /></a>
