...
<div class="row-fluid">
    ...
    <div class="span6">
    	...
    	<a href="<?php echo JRoute::_("index.php?option=com_gamification&task=rank.removeimage&id=".(int)$this->item->id."&".JSession::getFormToken()."=1");?>"><?php echo JText::_("COM_GAMIFICATION_REMOVE_IMAGE");?></a>
    	</div> 
    </div>
    <?php }?>
</div>