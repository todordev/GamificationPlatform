...
<div class="row-fluid">
    ...
    <div class="span6">
    	...
    	<br /><br />
	   <a class="btn btn-mini btn-danger" href="<?php echo JRoute::_("index.php?option=com_gamification&task=rank.removeimage&id=".(int)$this->item->id."&".JSession::getFormToken()."=1");?>">
