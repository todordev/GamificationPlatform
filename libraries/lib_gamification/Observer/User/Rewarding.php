...
use Gamification\User\Reward\RewardPointsSeeker;
use Gamification\User\Reward\RewardManager;
 ...
 * @since        3.1.2
 */
class Rewarding extends PointsObserver
{
    /**
