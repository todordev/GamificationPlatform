...
use Gamification\User\Achievement\AchievementPointsSeeker;
use Gamification\User\Achievement\AchievementManager;
 ...
 * @since        3.1.2
 */
class Accomplishing extends PointsObserver
{
    /**
