...
<div class="gfy-notifications<?php echo $this->pageclass_sfx;?>" id="js-gfy-notifications">
    ...
    ?>
    <div class="row-fluid gfy-notification <?php echo $notReadClass;?>" id="js-gfy-note-element<?php echo $item->id;?>">
        <div class="span10">
            <div class="media">
        ...
        <div class="span1">
            <a href="<?php echo JRoute::_("index.php?option=com_gamification&task=notification.remove");?>" data-element-id="<?php echo (int)$item->id;?>" class="gfy-btn-remove-notification">
