...
// Load router
if(!class_exists("GamificationHelperRoute")) {
    JLoader::register("GamificationHelperRoute", JPATH_SITE . DIRECTORY_SEPARATOR. "components" . DIRECTORY_SEPARATOR ."com_gamification". DIRECTORY_SEPARATOR . "helpers" . DIRECTORY_SEPARATOR . "route.php");
}
